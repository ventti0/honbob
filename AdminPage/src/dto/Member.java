...
public class Member {
	...
	public String toString() {
		return "Member [mem_no=" + mem_no + ", mem_group_no=" + mem_group_no + ", mem_id=" + mem_id + ", mem_pw="
				+ mem_pw + ", mem_name=" + mem_name + ", mem_nick=" + mem_nick + ", mem_birth=" + mem_birth
				+ ", mem_gen=" + mem_gen + ", mem_phone=" + mem_phone + ", mem_addr1=" + mem_addr1 + ", mem_addr2="
				+ mem_addr2 + ", mem_point=" + mem_point + ", mem_acc_point=" + mem_acc_point + ", mem_grade="
				+ mem_grade + "]";
	}
